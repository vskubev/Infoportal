...
public class MotherCapitalPage extends BasePage { //распоряжении средствами материнского капитала https://gu.spb.ru/187961/eservice/
    private WebDriver driver;

    public MotherCapitalPage(WebDriver driver){
    ...
    private By eserviceMethodButton = By.xpath("//a[@href='/187961/eservice/']");
    private By mfcMethodButton = By.xpath("//a[@href='/187961/mfcservice/']");
    private By traditionalMethodButton = By.xpath("//a[@href='/187961/traditional/']");
    ...
    private By getServiceButton =
            By.xpath("//a[@href='https://eservice.gu.spb.ru/portalFront/resources/portal.html?widget=capital#openPlatform']");
